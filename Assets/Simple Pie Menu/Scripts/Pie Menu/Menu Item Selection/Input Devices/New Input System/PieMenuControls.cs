    ...
    ""controlSchemes"": []
        ...
        public struct MouseAndKeyboardActions
        {
            ...
            public void SetCallbacks(IMouseAndKeyboardActions instance)
            {
                ...
                {
                    @Selection.started -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnSelection;
                    @Selection.performed -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnSelection;
                    @Selection.canceled -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnSelection;
                    @Close.started -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnClose;
                    @Close.performed -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnClose;
                    @Close.canceled -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnClose;
                    @PointerPosition.started -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnPointerPosition;
                    @PointerPosition.performed -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnPointerPosition;
                    @PointerPosition.canceled -= m_Wrapper.m_MouseAndKeyboardActionsCallbackInterface.OnPointerPosition;
                }
